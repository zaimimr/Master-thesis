...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node (step1_1) [process1] {Generate Random Architectures};
    \node (step1_2) [process2, below=of step1_1] {Conduct Comprehensive Training on Architectures for Benchmarking};
    \node (step2_1) [process1, right=of step1_1] {Research Zero-Cost Proxies};
    \node (step2_2) [process2, below=of step2_1] {Establish Zero-Cost Proxy Framework};
    \node (step3) [process1, below=2cm of $(step1_2)!0.5!(step2_2)$] {Collect Data on Zero-Cost Proxies Performance};
    \node (step4) [process2, below=of step3] {Perform Quantitative Analysis Using Collected Data};

    \draw [arrow] (step1_1) -- (step1_2);
    \draw [arrow] (step1_2) -- (step3);
    \draw [arrow] (step2_1) -- (step2_2);
    \draw [arrow] (step2_2) -- (step3);
...
\input{chapters/4-method/dataset.tex}
\input{chapters/4-method/benchmark.tex}
\input{chapters/4-method/ZC-Proxies.tex}
\input{chapters/4-method/zero_cost_framework}
\input{chapters/4-method/Correlation}
\input{chapters/4-method/warmup}
\input{chapters/4-method/combining_zero_cost_proxies}